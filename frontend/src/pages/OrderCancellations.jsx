...
import {
  ...
  ThumbsUp, ThumbsDown, PackageX, Phone, Hash, AlertTriangle
} from 'lucide-react';
  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      ...
      const [all, pending] = await Promise.all([
        api.get('/api/orders/cancellation-requests', { params }),
        api.get('/api/orders/cancellation-requests', { params: { status: 'PENDING' } })
      ]);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-2xl p-5">
            <div className="flex items-center justify-between">
              <span className="text-emerald-400 font-black uppercase text-xs tracking-widest">Approved</span>
        ...
        {requests.length === 0 ? (
          <div className="text-center py-20 bg-gray-900/50 border border-gray-800 rounded-2xl">
            ...
            <p className="text-gray-400 font-bold">No cancellation requests found</p>
          </div>
        ) : (
