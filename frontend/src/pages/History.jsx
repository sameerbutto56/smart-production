      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-10">
        ...
        <div className="flex flex-wrap items-center gap-4">
           <div className="relative group w-full sm:w-80">
              <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-indigo-500 transition-all duration-300" size={20} />
              <input
                type="text"
                placeholder="Search archive..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full bg-gray-950/80 border-2 border-gray-800 rounded-[1.5rem] py-4 pl-16 pr-6 focus:border-indigo-500 outline-none transition-all text-sm font-black text-white placeholder-gray-800"
              />
            </div>
