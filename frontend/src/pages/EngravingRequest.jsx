...
export default function EngravingRequest() {
  ...
  const fetchTasks = useCallback(async (showFeedback = false) => {
    ...
    try {
      ...
      if (showFeedback) toast.success('Engraving tasks refreshed');
    } catch (e) {
      console.error('Engraving tasks error:', e);
      if (showFeedback) toast.error('Failed to refresh engraving tasks');
    } finally {
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                title="Refresh engraving tasks"
              >
                <RefreshCcw size={14} className={tasksLoading ? 'animate-spin text-cyan-400' : 'text-gray-400'} />
