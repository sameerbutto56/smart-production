...
export function printJobSheet(order, userRole, lang = 'ur', sections = {}) {
  ...
  const urduSlMap = { 'full':'+�+� +�+�+�+�', 'half':'��+�+�', 'three-quarter':'+�+++��� +�+�+�+�+�+�', 'quarter':'+�+++��� +�+�+�+�+�+�' };
  const urduShMap = { 'long':'+�+�+��� +�+�+�+�', 'short':'+�+++�+��� +�+�+�+�', 'regular':'+���+�+�+�+�' };
  const urduFemSlMap = { 'full':'+�+� +�+�+�+�', 'half':'��+�+�', 'medium':'+�+�+��+�+��' };
  const urduFemShMap = { 'long':'+�+�+��� +�+�+�+�', 'short':'+�+++�+��� +�+�+�+�' };
  ...
  const colSleeveUR = { 'full':'+�+�', 'half':'��+�+�', 'three-quarter':'+�+++��� +�+�+�+�+�+�', 'regular':'+���+�+�+�+�', 'medium':'+��+��+�' };
  const colLengthEN = { 'long':'Long', 'regular':'Regular', 'short':'Short' };
  const colLengthUR = { 'long':'+�+�+�+�', 'regular':'+���+�+�+�+�', 'short':'+�+�+�+�' };
  const colSleeveDisp = (v) => v ? (isUrdu ? (colSleeveUR[v] || v) : (colSleeveEN[v] || v)) : 'G��';
  const colLengthDisp = (v) => v ? (isUrdu ? (colLengthUR[v] || v) : (colLengthEN[v] || v)) : 'G��';
  const slDisplay = (v) => v ? (isUrdu ? (urduSlMap[v] || v) : (slMap[v] || v)) : '';
  const shDisplay = (v) => v ? (isUrdu ? (urduShMap[v] || v) : (shMap[v] || v)) : '';
  const genDisplay = (g) => g ? (isUrdu ? (g === 'Male' ? '+�+�+�' : g === 'Female' ? '+�+�+�+�' : g) : g) : '';
  ...
  const title = `${sec.jobSheet} G�� ${order.orderNumber || order.id?.slice(0, 8)}`;
  ...
  // Hide the default .report-header from openPrintWindow G�� we write our own header below
  win.document.write('<style>.report-header{display:none!important}</style>');

  // G��G��G�� GENERATED DATE/TIME G��G��G��
  const now = new Date();
  ...
  // G��G��G�� ENTRY DATE/TIME & SHOPIFY DATE G��G��G��
  ...
  win.document.write(`<p style="font-size:20px;color:#000;margin-top:2px;font-weight:700">${isUrdu ? '+�+�+�+� #' : 'Order #'}${order.orderNumber || order.id?.slice(0, 8)}</p>`);
  win.document.write(`<p style="font-size:18px;color:#555;font-weight:600;margin-top:2px">ENAMELS Production</p>`);
  win.document.write(`<p style="font-size:15px;color:#999;font-weight:500;margin-top:2px">${isUrdu ? '+���+�+� +�+�+���:' : 'Generated:'} ${generatedDate} ${generatedTime}</p>`);
  win.document.write(`</div>`);

  // G��G��G�� CUSTOMER INFO (always LTR G�� customer data is English/Roman script) G��G��G��
  win.document.write(`<div dir="ltr" style="border:2px solid #ddd;border-radius:8px;padding:8px 12px;margin-bottom:8px">`);
  win.document.write(`<p style="font-size:22px;font-weight:900;color:#000;margin-bottom:2px">${order.customerName || 'G��'}</p>`);
  ...
  // G��G��G�� DATES ROW (always LTR G�� date values are English) G��G��G��
  ...
  win.document.write(`<div><span style="font-size:16px;font-weight:700;color:#000">${isUrdu ? '+�+�+�+�+�+� +�+� +�+�+�:' : 'Entry Time:'}</span> <span style="font-size:18px;font-weight:900;color:#111">${entryTime}</span></div>`);
  if (shopifyDate) {
  ...
  // G��G��G�� ORDER PLACED BY G��G��G��
  if (order.placedBy) {
    const placedLabel = isUrdu ? '+�+�+�+� +�+� +�� +���+�:' : 'Order Placed By:';
  ...
  // G��G��G�� OUTLET SOURCE LABEL G��G��G��
  if (order.source === 'OUTLET' && order.outletName) {
    ...
    win.document.write(`<span style="font-size:22px;font-weight:900;color:#7c3aed;text-transform:uppercase">${isUrdu ? '+�+�+�+�:' : 'Source:'} ${pu(order.outletName)}</span>`);
    win.document.write(`</div>`);
  }

  // G��G��G�� ORDER META BADGES G��G��G��
  win.document.write(`<div style="display:flex;gap:6px;margin-bottom:8px;flex-wrap:wrap">`);
  const badgeLabels = {
    'PAID': isUrdu ? '+�+�+� +�+���' : 'PAID',
    'FULL_CUSTOM': isUrdu ? '+�+� +�+�+�+�' : 'FULL CUSTOM',
    'STANDARD': isUrdu ? '+�+�+���+�+�+�+�' : 'STANDARD',
    'READY_LOGO': isUrdu ? '+���+�� +�+�+�+�' : 'READY LOGO',
    'SUPER_URGENT': isUrdu ? '+�+�+���+�+��� +�+�+�+�+�' : 'SUPER URGENT',
    'URGENT': isUrdu ? '+�+�+�+�+�' : 'URGENT',
    'OUTLET': isUrdu ? '+�+�+� +��+�' : 'OUTLET',
    'CASH ON DELIVERY': isUrdu ? '+�+�+� +�+��+�+���' : 'CASH ON DELIVERY',
  };
  ...
  // G��G��G�� PRODUCTS TABLE G��G��G��
  const sleeveLabel = isUrdu ? '+�+�+�+�' : 'Sleeve';
  const lengthLabel = isUrdu ? '+�+�+�+�+���' : 'Length';
  ...
  // G��G��G�� MEASUREMENT SECTION G��G��G��
  if (showMeas) {
    ...
    if (selectedSize || measNote) {
      ...
      if (selectedSize) {
        win.document.write(`<p style="font-size:22px;font-weight:700;color:#000;margin-bottom:${measNote ? '6px' : '0'}">${isUrdu ? '+�+�+�+�+� +�+�+�+�:' : 'Selected Size:'} ${selectedSize}</p>`);
      }
      if (measNote) {
  ...
  // G��G��G�� MEASUREMENT SPECIAL NOTE (also shown standalone when engraving is disabled) G��G��G��
  ...
  // G��G��G�� ENGRAVING / BRANDING G��G��G��
  if (orderType !== 'STANDARD' && showEngraving) {
    ...
    if (hasAnyCustomization || outHasEngraving) {
      ...
      if (hasAnyCustomization) {
        brandingItems.forEach((item, idx) => {
          ...
          if (hasSpecs) {
            ...
            if (c.logoColor) win.document.write(`<span style="font-size:18px;font-weight:700;padding:3px 8px;border-radius:4px;background:#fef3c7;color:#92400e">${isUrdu ? '+�+�+�+�:' : 'Logo:'} ${vu(c.logoColor)}</span>`);
            win.document.write(`</div>`);
          }
          ...
          if (hasLogos) {
            ...
            c.logos.filter(l => (l.name && l.design) || (l.name?.length > 2 || l.design?.length > 2)).forEach((l, li) => {
              win.document.write(`<div style="font-size:22px;font-weight:700;background:#fffbeb;padding:3px 8px;border-radius:4px;margin-bottom:2px;border:2px solid #fef3c7">${l.name || l.design}${l.name && l.design ? ` G�� ${l.design}` : ''}</div>`);
            });
            win.document.write(`</div>`);
          }
      ...
      if (outHasEngraving) {
        ...
        win.document.write(`<span style="background:#7c3aed;color:#fff;width:26px;height:26px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:20px;font-weight:800">G��</span>`);
        win.document.write(`<span style="font-weight:900;font-size:22px;text-transform:uppercase;color:#7c3aed">${isUrdu ? '+�+�+� +��+� +�+�+++�+���' : 'Outlet Engraving'}</span>`);
        win.document.write(`</div>`);
