...
const { clearAllData, togglePause, getPauseStatus, getDeadlineConfig, updateDeadlineConfig, getPerformanceAnalytics, getTheme, updateTheme } = require('../controllers/admin.controller');
