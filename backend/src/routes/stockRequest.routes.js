...
const { createRequest, getRequests, getRequestById, approveRequest, rejectRequest, completeRequest, getLowStockItems, exportRequestsExcel, getWarehouseAnalytics } = require('../controllers/stockRequest.controller');
...
router.get('/warehouse-analytics', authenticate, authorize(['STORE', 'ADMIN', 'SUPER_ADMIN']), getWarehouseAnalytics);
